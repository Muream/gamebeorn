...
measureText :: proc "c" (
    ...
    for i in 0 ..< int(text.length) {
        ...
        if (fontToUse.glyphs[index].advanceX != 0) {
            ...
            lineTextWidth +=
                (fontToUse.recs[index].width +
                    cast(f32)fontToUse.glyphs[index].offsetX)
        }
    }
...
clayRaylibRender :: proc(
    ...
    for i in 0 ..< int(renderCommands.length) {
        ...
        case clay.RenderCommandType.Rectangle:
            config: ^clay.RectangleElementConfig =
        ...
        case clay.RenderCommandType.Border:
            ...
            if (config.cornerRadius.topLeft > 0) {
                raylib.DrawRing(
                    ...
                    math.round(
                        config.cornerRadius.topLeft - cast(f32)config.top.width,
                    ),
                    config.cornerRadius.topLeft,
                    180,
                    270,
            ...
            if (config.cornerRadius.topRight > 0) {
                raylib.DrawRing(
                    ...
                    math.round(
                        config.cornerRadius.topRight - cast(f32)config.top.width,
                    ),
                    config.cornerRadius.topRight,
                    270,
                    360,
            ...
            if (config.cornerRadius.bottomLeft > 0) {
                raylib.DrawRing(
                    ...
                    math.round(
                        config.cornerRadius.bottomLeft - cast(f32)config.top.width,
                    ),
                    config.cornerRadius.bottomLeft,
                    90,
                    180,
            ...
            if (config.cornerRadius.bottomRight > 0) {
                raylib.DrawRing(
                    ...
                    math.round(
                        config.cornerRadius.bottomRight - cast(f32)config.bottom.width,
                    ),
                    config.cornerRadius.bottomRight,
                    0.1,
                    90,
